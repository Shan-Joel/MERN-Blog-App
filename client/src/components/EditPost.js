         ...
         <div className="col-md-8 mt-4 mx-auto">
            ...
            <form className="needs-validation" noValidate>
               <div className="form-group" style={{ marginBottom: '15px' }}>
                  ...
                  <input type="text" className="form-control" name="topic" placeholder="Enter topic" value={this.state.topic} onChange={this.handleInputChange} />
               </div>
               ...
               <div className="form-group" style={{ marginBottom: '15px' }}>
                  ...
                  <input type="text" className="form-control" name="postCategory" placeholder="Enter post category" value={this.state.postCategory} onChange={this.handleInputChange} />
               </div>
